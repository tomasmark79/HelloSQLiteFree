 ...
 * @file    SQLiteCpp.h
 * @ingroup SQLiteCpp
 * @brief   SQLiteC++ is a smart and simple C++ SQLite3 wrapper. This file is
 * only "easy include" for other files.
 *
 * Include this main header file in your project to gain access to all
...
/**
 * @brief Version numbers for SQLiteC++ are provided in the same way as
 * sqlite3.h
 *
 ...
 *
 * WARNING: shall always be updated in sync with PROJECT_VERSION in
 * CMakeLists.txt
 */
